...
const Dashboard = () => {
  ...
  const [selectedPeriod, setSelectedPeriod] = useState('Dezembro');
  const kpiData = {
    investment: 26000,
    visitors: 11350,
  ...
  const derivedKPIs = {
    conversionRate: ((kpiData.botConversations + kpiData.humanConversations) / kpiData.visitors * 100).toFixed(1),
    transferRate: (kpiData.humanConversations / kpiData.botConversations * 100).toFixed(1),
    proposalRate: (kpiData.proposals / kpiData.humanConversations * 100).toFixed(1),
    closingRate: (kpiData.closedDeals / kpiData.proposals * 100).toFixed(1),
    cpl: (kpiData.investment / (kpiData.botConversations + kpiData.humanConversations)).toFixed(2),
    cpf: (kpiData.investment / kpiData.closedDeals).toFixed(2)
  };
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-success/10 border border-success/30 rounded-lg">
                    ...
                    <ul className="text-xs text-foreground space-y-1">
                      <li>• Taxa de fechamento cresceu 18.9%</li>
                      <li>• CPF reduziu em 15.3%</li>
                      <li>• Volume de propostas +22.1%</li>
                    </ul>
                  </div>
                  <div className="p-3 bg-destructive/10 border border-destructive/30 rounded-lg">
                    <h4 className="font-semibold text-destructive mb-2 text-sm">Pontos de Atenção</h4>
                    <ul className="text-xs text-foreground space-y-1">
                      <li>• Conversas humanas caíram 5.2%</li>
                      <li>• Taxa de transbordo reduziu 3.2%</li>
                    </ul>
                  </div>
                </div>
              </Card>
